...
namespace PactNet
{
    ...
    internal class RequestBuilder : IRequestBuilderV2, IRequestBuilderV3, IRequestBuilderV4
    {
        ...
        internal RequestBuilder WithRequest(string method, string path)
        {
            ...
            this.driver.WithRequest(method, path);
            return this;
        }
        ...
        internal RequestBuilder WithHeader(string key, string value)
        {
            ...
            this.driver.WithRequestHeader(key, value, index);
        ...
        {
            this.driver.WithRequestBody(contentType, body);
            return this;
        }
        ...
        internal ResponseBuilder WillRespond()
        {
            ...
            var builder = new ResponseBuilder(this.driver, this.defaultSettings);
            return builder;
        }
    }
}
